...
namespace Elements
{
    ...
    const uint32_t moov_trak_mdia_minf_stbl_stco = 0x7374636F;
    const uint32_t moov_trak_mdia_minf_stbl_stsc = 0x73747363;
    const uint32_t moov_trak_mdia_minf_stbl_stsz = 0x7374737A;
    const uint32_t moov_trak_mdia_minf_stbl_stts = 0x73747473;
    ...
    const uint32_t moov_trak_mdia_minf_dinf = 0x64696E66;
    const uint32_t moov_trak_mdia_minf_dinf_dref = 0x64726566;
    const uint32_t moov_trak_mdia_minf_dinf_dref_url = 0x75726C20;
    ...
    const uint32_t moov_trak_mdia_minf_gmhd_gmin = 0x676D696E;
    const uint32_t moov_trak_mdia_minf_gmhd_text = 0x74657874;
    const uint32_t moov_trak_mdia_minf_gmhd_tmcd = 0x746D6364;
    const uint32_t moov_trak_mdia_minf_gmhd_tmcd_tcmi = 0x74636D69;
    const uint32_t moov_trak_mdia_mdhd = 0x6D646864;
    const uint32_t moov_trak_mdia_hdlr = 0x68646C72;
    const uint32_t moov_trak_mdia_minf_hdlr = 0x68646C72;
    const uint32_t moov_trak_tkhd = 0x746B6864;
    const uint32_t moov_trak_edts = 0x65647473;
    const uint32_t moov_trak_edts_elst = 0x656C7374;
...
CHUNK_I(3, moov_trak_mdia);
CHUNK_I(4, moov_trak_mdia_minf);
CHUNK_I(5, moov_trak_mdia_minf_stbl);
CHUNK_M(6, moov_trak_mdia_minf_stbl_stsd);
CHUNK_W(6, moov_trak_mdia_minf_stbl_stco);
CHUNK_W(6, moov_trak_mdia_minf_stbl_stsc);
CHUNK_W(6, moov_trak_mdia_minf_stbl_stsz);
CHUNK_W(6, moov_trak_mdia_minf_stbl_stts);
CHUNK_W(7, moov_trak_mdia_minf_stbl_stsd_tmcd);
...
CHUNK_I(5, moov_trak_mdia_minf_dinf);
CHUNK_M(6, moov_trak_mdia_minf_dinf_dref);
CHUNK_W(7, moov_trak_mdia_minf_dinf_dref_url);
CHUNK__(5, moov_trak_mdia_minf_vmhd);
CHUNK__(5, moov_trak_mdia_minf_smhd);
CHUNK_I(5, moov_trak_mdia_minf_gmhd);
CHUNK_W(6, moov_trak_mdia_minf_gmhd_gmin);
CHUNK_W(6, moov_trak_mdia_minf_gmhd_text);
CHUNK_I(5, moov_trak_mdia_minf_gmhd_tmcd);
CHUNK_W(6, moov_trak_mdia_minf_gmhd_tmcd_tcmi);
CHUNK_W(4, moov_trak_mdia_mdhd);
CHUNK_W(4, moov_trak_mdia_hdlr);
CHUNK_W(5, moov_trak_mdia_minf_hdlr);
CHUNK_W(3, moov_trak_tkhd);
CHUNK_I(3, moov_trak_edts);
CHUNK_W(4, moov_trak_edts_elst);
CHUNK_I(3, moov_trak_tref);
